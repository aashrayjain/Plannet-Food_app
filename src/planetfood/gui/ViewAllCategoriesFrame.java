...
public class ViewAllCategoriesFrame extends javax.swing.JFrame {
    ...
    private void loadDataInTable(){
        try{
            ...
            if(categories.isEmpty())
                JOptionPane.showMessageDialog(null, "Sorry!No Categories present", "Error!",JOptionPane.ERROR_MESSAGE);
            else{
                Object []rows=new Object[2];
                DefaultTableModel model=(DefaultTableModel)jtCatDetails.getModel();
                for(String catName:categories.keySet()){
                    rows[0]=categories.get(catName);
                    rows[1]=catName;
                    model.addRow(rows);
                }
            }
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon("H:\\java project classwork notes\\Images\\menu-6.png")); // NOI18N
